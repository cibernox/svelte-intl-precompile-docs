...
<svelte:head>
	<title>Svelte Intl Precompile</title>
</svelte:head>

<div class="mt-10 mx-auto sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 text-center">
	<svg class="mx-auto h-48 w-48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 98.1 118">
		<style type="text/css">
			.st0{fill:#FF3E00;}
			.st1{fill:#FFFFFF;}
		</style>
	...
	<h1 class="text-6xl font-extrabold text-gray-900 sm:text-5xl">
		<span class="block xl:inline">Svelte Intl Precompile</span>
	</h1>
	<p class="mt-3 text-base text-gray-500 text-xl">
